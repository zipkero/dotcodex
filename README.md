...
이 문서들은 범위, 결정 사항, 구현 상태의 source of truth이다.
...
전역 지침과 사용자 정의 skill은 강한 추론과 자율 실행 성향을 가진 모델이 요청 범위를
과하게 확장하지 않도록 경계를 명확히 둔다.
...
- Markdown 문서는 한 줄 표시폭 120칸을 넘기지 않도록 줄바꿈한다.
